...
root.render(
  React.createElement(React.StrictMode, null,
    React.createElement(ErrorBoundary, {
      fallbackMessage: "There was an issue loading the main application. Please check the console for more details.",
      children: React.createElement(App, null) // App component is now a value for the 'children' prop
    })
  )
);